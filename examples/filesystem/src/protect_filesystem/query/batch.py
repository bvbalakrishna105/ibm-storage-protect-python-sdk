"""
Query Batch Filesystem Backups
================================

Query metadata for multiple files that were backed up in a batch.
This script queries multiple backed up files.
"""
...
def query_batch_backups():
    """Query all batch backed up files"""
    ...
    print("="*70)
    print("QUERY BATCH FILESYSTEM BACKUPS")
    print("="*70)
    print(f"\nFilespace: {filespace}")
