"""
Query Single Filesystem Backup
================================

Query metadata for a single backed up file.
This script queries a backed up file from the filesystem.
"""
...
def query_single_backup():
    ...
    print("="*70)
    print("QUERY SINGLE FILESYSTEM BACKUP")
    print("="*70)
