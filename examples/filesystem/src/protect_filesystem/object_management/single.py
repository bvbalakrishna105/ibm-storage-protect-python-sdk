"""
Single Object Management for Filesystem Backups
================================================

Demonstrates object management operations (rename, update, delete) on a single
backed-up file in IBM Storage Protect.
"""
...
def main():
    ...
    original_key = "/path/to/data/example.json"
    ...
    try:
        ...
        new_key = "/path/to/data/example_renamed.json"
        ...
        print("Setting owner: file_admin")
