"""
Single Object Partial Restoration for PostgreSQL
=================================================

Demonstrates partial (byte-range) restoration for a single PostgreSQL database file.
...
if __name__ == "__main__":
    ...
    try:
        ...
        output_file = OUTPUT_DIR / f"ecommerce_db_{START_BYTE}_{END_BYTE}_restored.tar.gz"
