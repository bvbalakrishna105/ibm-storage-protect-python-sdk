...
List all backed up PostgreSQL database files in the /postgres_bckp filespace.
...
def list_all_backups():
    """List all PostgreSQL backups in the filespace"""
    ...
    print("="*70)
    print("LIST ALL POSTGRESQL BACKUPS")
    print("="*70)
    ...
    try:
        ...
        if results.key_count > 0:
            ...
            for obj in results.contents:
                ...
                elif 'batch_backup_dummy_data' in key:
                    batch_backups.append((filename, obj))
                elif 'normal_backup_dummy_data' in key:
